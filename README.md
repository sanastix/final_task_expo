...
1. Користувач реєструється в системі і далі має можливість:
   - здійснювати пошук;
   - купити квиток на обрану експозицію.

2. Незареєстрований користувач не може купити квиток (тільки пошук).
...
4. Адміністратор системи володіє правами:
   - додавання/видалення експозиції, редагування інформації про експозицію (тема, зал - один або декілька, період та час роботи, вартість квитка);
